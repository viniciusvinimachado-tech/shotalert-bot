...
def start(update, context):
    update.message.reply_text(
        "🤖 *Shot Alert Bot v6.8.5 - Sportmonks*\n\n"
...
def ping(update, context):
    update.message.reply_text("✅ Bot v6.8.5 online! Sportmonks stats temporada OK")
...
@app.route('/')
def index():
    return 'Bot v6.8.5 Sportmonks Online'
