...
def ping(update, context):
    update.message.reply_text("✅ Bot v6.4.1 online! UTC | Webhook OK")
...
app = Flask(__name__)
bot = Bot(token=TOKEN)
dp = Dispatcher(bot, None, workers=1, use_context=True) # FIX: workers=1
