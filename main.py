...
async def ping(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("✅ Basket Bot v2.2 online! ESPN + Props OK")
...
@app.route('/')
def index():
    return 'Basket Bot v2.2 ESPN Online'
