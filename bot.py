...
def ping(update, context):
    update.message.reply_text("✅ Bot v6.1 online! 🌍 17 ligas | 🎯 Filtro 75%+ | 📅 Season auto")
...
if __name__ == "__main__":
    ...
    logging.info(f"Bot v6.1 rodando — API-Football! Porta: {PORT}")
