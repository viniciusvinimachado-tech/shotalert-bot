...
dispatcher.add_handler(CommandHandler("antecipados", antecipados))
dispatcher.add_handler(CommandHandler("setid", setid))
dispatcher.add_handler(CommandHandler("ligas", ligas))
dispatcher.add_handler(CommandHandler("historico", historico))
dispatcher.add_handler(CommandHandler("relatorio", relatorio))
dispatcher.add_handler(CommandHandler("diagnostico", diagnostico))
...
if __name__ == "__main__":
    ...
    logging.info(f"Bot v6.0 rodando — API-Football! Porta: {PORT}")
